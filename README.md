...
6.	Once it is done loading, try running the HelloWorld.java's main.java.main function. It is found in src/main.java.main/java/HelloWorld.java. If you get an error message like "release version 12 not supported," select File -> Settings -> Build, Execution, Deployment -> Compiler -> Java Compiler and change the target byteode version to 8
